...
class CreateFlightsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('flights', function (Blueprint $table) {
            ...
            $table->time('time_output');  //orario saida
            $table->time('arrival_time'); // orario chegado
            $table->double('old_price', 10, 2);  //preco anterior
            $table->double('price', 10, 2);      // preco atual
            $table->integer('total_plots');  //total parcelas
